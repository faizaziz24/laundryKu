...
<!-- Breadcrumb-->
<ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>stagelist">Stages</a></li>
  <li class="breadcrumb-item active">Add Stage</li>
</ol>
      ...
      <div class="col-lg-6">
        ...
        <div class="card">
          <div class="card-header">
            <strong>Stage</strong> Form</div>
            <?php $this->load->helper("form"); ?>
              <form action="<?php echo base_url(); ?>savenewstage" method="post" role="form" id="addStage">
                  <div class="card-body">
