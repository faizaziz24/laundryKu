              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <i class="nav-icon icon-basket-loaded"></i>Order List Table</div>
                  <div class="card-body">
                    <div class="form-group row">
                      <div class="col-md-12">
                        <form action="<?php echo base_url() ?>orderlist" method="POST" id="searchList">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"> 
                                <a class="btn btn-sm btn-info" href="<?php echo base_url().'editoldorder/'.$record->orderId; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
